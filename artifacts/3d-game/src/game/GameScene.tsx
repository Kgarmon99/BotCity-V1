...
export const BUILDING_DEFS: Omit<BuildingData, "visited" | "available">[] = [
  ...
  // ════════════════════════════════════════════════════════════════════
  // ── Foundations 🧠 (cyan #22d3ee), centered (-13, -91) — directly north of BotThrift & Resale ──
  { id: "botmint",        label: "BotMint",              position: [-13, 1.5, -91], color: "#22d3ee", roofColor: "#fbbf24", width: 1.8, depth: 1.8, height: 3, emoji: "💵" },
  { id: "botbudget",      label: "BotBudget Cafe",       position: [-13, 1.5, -99], color: "#06b6d4", roofColor: "#fde047", width: 1.8, depth: 1.8, height: 3, emoji: "📒" },
  { id: "botsavings",     label: "BotSavings Plaza",     position: [-13, 1.5, -83], color: "#0891b2", roofColor: "#fbbf24", width: 1.8, depth: 1.8, height: 3, emoji: "🐷" },
  { id: "botcreditbureau",label: "BotCredit Bureau",     position: [-5, 1.5, -91], color: "#0e7490", roofColor: "#22d3ee", width: 1.8, depth: 1.8, height: 3, emoji: "📇" },
  { id: "botbehavioral",  label: "BotBehavioral Lab",    position: [-21, 1.5, -91], color: "#155e75", roofColor: "#67e8f9", width: 1.8, depth: 1.8, height: 3, emoji: "🧠" },
  ...
  { id: "botads",         label: "BotAds & Marketing",    position: [3, 1.5, -91], color: "#10b981", roofColor: "#fbbf24", width: 1.8, depth: 1.8, height: 3, emoji: "📺" }, // placed next to BotCredit Bureau (-5,-91), continuing the Foundations row east
