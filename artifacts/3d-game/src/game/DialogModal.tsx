...
const BUILDING_DOCS: Record<string, TaxDocument> = {
  ...
  botunorth: { id: "1098e", code: "1098-E", label: "Student loan interest", icon: "🎓", line: "21" },
  botusouth: { id: "1098t", code: "1098-T", label: "Tuition statement", icon: "🎓", line: "Sch 3" },
  ...
  moneybotgaminghq: { id: "streamer-1099", code: "1099-MISC", label: "Streaming & creator income", icon: "🎮", line: "Sch C" },
